    ...
    <footer ref={footerRef} className="bg-[#0f1b2e] text-white w-full border-t-[4px] border-[#c69c4e] relative z-50">
          ...
          <div className="footer-column lg:col-span-1">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-white/70 text-[13px]">
                ...
                <span>+91 8788051004</span>
              </li>
              <li className="flex items-start gap-3 text-white/70 text-[13px]">
                <Mail size={16} className="shrink-0 mt-0.5 text-[#c69c4e]" />
                <a href="mailto:admin.namohhoreca@gmail.com" className="hover:text-white transition-colors">admin.namohhoreca@gmail.com</a>
              </li>
            </ul>
          </div>
      ...
      <div className="footer-bottom-bar bg-[#0a1220] py-4">
        <div className="max-w-[1400px] mx-auto px-6 flex flex-col items-center justify-center text-center gap-1.5">
          ...
          <p className="text-white/50 text-[11px] md:text-[12px] tracking-wide">
            Developed By <a href="https://mindaxisinnovation.com/" target="_blank" rel="noopener noreferrer" className="text-white font-bold hover:text-[#c69c4e] transition-colors">Mind Axis Innovation PVT LTD</a>
          </p>
        </div>
      </div>
